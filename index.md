...
[Description](#desc) | [Install](#install) | [Configuration and Usage](#config) | [API](#api)
...
Trees are described in so many ways: "parents" and "children", "nodes" and "edges", "branches" and "leaves", "folders" and "items" etc.
...
- A node in an elementree Tree is a key-value pair.
...
- The elementree Tree has a single point of origin, called the "root node". If your tree has multiple roots have no fear and read on.
