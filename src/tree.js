...
export class Tree {
  ...
  /**
   * tests whether all qualifying datums pass the test implemented by the provided function
   * Warning: This method returns true when the qualifiying datums are an empty array
